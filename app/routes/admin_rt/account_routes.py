...
def admin_account():
    ...
    # ✅ CORRECTION : Ajouter nom_complet et date_creation pour le template
    admin["nom_complet"] = admin.get("nom", "")
    admin["date_creation"] = admin.get("created_at", "")
...
def update_admin_password():
    ...
    if result.get("error"):
        ...
        elif result["error"] == "ADMIN_NOT_FOUND":
